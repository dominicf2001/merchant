...
module.exports = {
    ...
    use: function (message, args) {
        return __awaiter(this, void 0, void 0, function () {
            var toSend, attachmentsArray, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        toSend = args.join(" ");
                        attachmentsArray = __spreadArray([], message.attachments.values(), true);
                    ...
                    case 4: return [2 /*return*/, message.channel.send({
                            content: toSend ? "@everyone\n\n <@".concat(message.author.id, "> says: ").concat(toSend) : '@everyone',
