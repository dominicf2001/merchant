...
module.exports = {
    ...
    use: function (message, args) {
        return __awaiter(this, void 0, void 0, function () {
            var morphObject, morphArgs, _a, iconUrl, newServerName, bannerUrl, channelId, newChannelName, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        morphObject = args[0];
                        morphArgs = args.filter(function (arg) { return arg !== morphObject; });
                        if (!morphObject) {
                    ...
                    case 1:
                        ...
                        _a = morphObject;
                        switch (_a) {
                            case "icon": return [3 /*break*/, 2];
                            case "name": return [3 /*break*/, 4];
                            case "banner": return [3 /*break*/, 5];
                            case "channel": return [3 /*break*/, 7];
                        }
                        return [3 /*break*/, 9];
                    case 2:
                        iconUrl = message.attachments.first()["url"];
                        return [4 /*yield*/, message.guild.setIcon(iconUrl)];
                    case 3:
                        _b.sent();
                        message.channel.send("Server icon has been morphed.");
                        return [3 /*break*/, 10];
                    case 4:
                        newServerName = morphArgs.join(" ");
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, message.guild.setBanner(bannerUrl)];
                    case 6:
                        _b.sent();
                    ...
                    case 7:
                        ...
                        newChannelName = morphArgs.join(" ");
                        return [4 /*yield*/, message.guild.channels.edit(channelId, { name: newChannelName })];
                    case 8:
                        _b.sent();
                        message.channel.send("Channel name has been morphed.");
                        return [3 /*break*/, 10];
                    case 9: throw new Error('Invalid morph object.');
