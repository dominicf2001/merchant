...
module.exports = {
    ...
    use: function (message, args) {
        return __awaiter(this, void 0, void 0, function () {
            var targetArg, newNicknameArgs, id, target, newNickname, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        targetArg = args.filter(function (arg) { return arg.startsWith('<@') && arg.endsWith('>'); })[0];
                        newNicknameArgs = args.filter(function (arg) { return arg !== targetArg; });
                        if (!targetArg) {
                        ...
                        newNickname = newNicknameArgs.join(" ");
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, target.setNickname(newNickname)];
                    case 2:
                        _a.sent();
                        message.channel.send("Nickname of <@".concat(target.id, "> has been changed to ").concat(newNickname));
                        return [3 /*break*/, 4];
                    case 3:
                        error_1 = _a.sent();
