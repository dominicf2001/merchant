...
var _a = require("../../utilities.js"), tendieIconCode = _a.tendieIconCode, formatNumber = _a.formatNumber;
module.exports = {
    data: {
        name: 'bal',
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                embed = new EmbedBuilder()
                    .setColor("Blurple")
                    .addFields({ value: "".concat(tendieIconCode, " ").concat(formatNumber(+getBalance(message.author.id))), name: "Balance" });
