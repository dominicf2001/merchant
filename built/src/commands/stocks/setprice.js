...
var setStockPrice = require("../../database/utilities/stockUtilities.js").setStockPrice;
module.exports = {
    data: {
        name: 'setprice',
            ...
            return __generator(this, function (_a) {
                ...
                try {
                    ...
                    embed = new EmbedBuilder()
                        .setColor("Blurple")
                        .setFields({
                        name: "".concat(inlineCode(id), "'s price set to: ").concat(tendieIconCode, " ").concat(newPrice),
                        value: " "
                    });
