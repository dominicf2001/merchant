...
var Stocks = require("../../database/dbObjects.js").Stocks;
var latestStocksCache = require("../../database/utilities/stockUtilities.js").latestStocksCache;
module.exports = {
    data: {
        name: 'createstock',
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        console.error("Error creating stock: ", error_1);
                        return [2 /*return*/, message.reply("Error creating stock.")];
